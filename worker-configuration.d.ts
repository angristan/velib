/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null` (hash: 9f334b8d7ae87b2dd31245af2471ba14)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 
interface __BaseEnv_Env {
	DB: D1Database;
	API_RATE_LIMITER: RateLimit;
	SESSION_RATE_LIMITER: RateLimit;
	OBSERVATIONS: import("cloudflare:pipelines").Pipeline<Cloudflare.VelibStationObservationsStreamV1Record>;
	APP_ENV: "production";
	APP_ORIGIN: "https://velib.stanislas.cloud";
	HISTORY_BACKEND: "d1";
	R2_SQL_ACCOUNT_ID: "47d71747660aab24284661867a77ed71";
	R2_SQL_BUCKET: "velib-analytics";
	TURNSTILE_HOSTNAME: "velib.stanislas.cloud";
	TURNSTILE_SITE_KEY: "0x4AAAAAAD6omDRMusYD6r0s";
	SESSION_TTL: "30m";
	TURNSTILE_SECRET_KEY: string;
	SESSION_SIGNING_SECRET: string;
	LIVE_FEED: DurableObjectNamespace<import("./src/worker/index").LiveFeed>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "LiveFeed";
	}
	type VelibStationObservationsStreamV1Record = { event_id: string; observed_at: number; source_updated_at: number; bucket_at: number; station_code: number; capacity: number; mechanical: number; electric: number; docks: number; unavailable: number; operative: boolean; last_reported_at: number };
